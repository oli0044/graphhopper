 ...
 */
package com.graphhopper.api.util.details;
...
public class PathDetail {
    ...
    public PathDetail(Object value) { // has to be made public in spite of above comment, since this class in subpackage api
        this.value = value;
    }
